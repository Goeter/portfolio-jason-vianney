...
function LatestProjectCard({ project }: { project: Project }) {
  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-cyan-300/20 bg-slate-950/80 text-slate-50 shadow-[0_20px_60px_rgba(0,0,0,0.4)] backdrop-blur-xl transition-all duration-500 ease-fluid hover:-translate-y-1.5 hover:border-cyan-300/50 hover:shadow-[0_28px_80px_rgba(14,165,233,0.2)]">
      ...
      <div className="relative aspect-[16/10] overflow-hidden border-b border-cyan-200/15 bg-slate-900">
        <Image
          src={project.image}
        ...
        <span className="absolute bottom-3 left-3 z-20 rounded-full border border-cyan-200/40 bg-slate-950/85 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-cyan-100 shadow-sm backdrop-blur-md">
          {projectCategoryLabels[project.category]}
        </span>
      </div>

      <div className="relative z-10 flex flex-1 flex-col p-5">
        <h3 className="min-h-[54px] break-words text-[17px] font-bold leading-snug tracking-tight text-slate-50 transition group-hover:text-cyan-200">
          {project.title}
        </h3>
        ...
        <div className="my-5 h-px bg-gradient-to-r from-cyan-300/30 via-slate-700/40 to-transparent" />

        <div className="flex min-h-[34px] flex-wrap items-center justify-between gap-3">
          <Link
            href={getProjectPath(project)}
            className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white px-4 py-2 text-[12px] font-bold uppercase tracking-[0.08em] text-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-cyan-300 hover:bg-cyan-100 hover:shadow-md"
          >
            See Details
          </Link>
          ...
          {project.link ? (
            <a
              href={project.link}
              className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-400/70 bg-cyan-400/15 px-4 py-2 text-[12px] font-bold uppercase tracking-[0.08em] text-cyan-100 shadow-[0_10px_24px_rgba(14,165,233,0.18)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-cyan-400 hover:text-slate-950 hover:shadow-[0_14px_30px_rgba(6,182,212,0.28)]"
            >
              View Project
    ...
    >
      ...
      <main className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-16 pt-9 sm:px-8 lg:px-12">
        ...
        <section className="mx-auto max-w-5xl text-center">
          <h1 className="mx-auto max-w-5xl break-words bg-gradient-to-r from-slate-50 via-sky-200 to-cyan-300 bg-clip-text pb-3 text-3xl font-black leading-[1.12] tracking-[-0.03em] text-transparent md:text-5xl">
            {project.title}
          </h1>
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-300/30 bg-slate-950/80 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-sky-200 shadow-sm backdrop-blur-md">
        ...
        {/* ── Image Gallery ── */}
        <section className="mx-auto mt-10 max-w-6xl overflow-hidden rounded-[32px] border border-cyan-300/20 bg-slate-950/70 p-3 shadow-[0_24px_70px_rgba(0,0,0,0.5)] backdrop-blur-xl md:p-4">
          <div
                ...
                return (
                  <button
                    ...
                    className={`relative h-20 w-32 shrink-0 overflow-hidden rounded-2xl border-2 bg-slate-950 transition-all duration-300 md:h-24 md:w-40 ${
                      active
                        ? "border-sky-400 shadow-[0_8px_20px_rgba(14,165,233,0.35)] ring-2 ring-sky-300/40"
                        : "border-slate-800 opacity-60 hover:border-sky-300 hover:opacity-100"
                    }`}
                  >
                    <Image
                      src={src}
        ...
        {/* ── Project Overview ── */}
        <section className="mx-auto mt-8 max-w-6xl overflow-hidden rounded-[30px] border border-cyan-300/20 bg-slate-950/80 shadow-[0_22px_70px_rgba(0,0,0,0.4)] backdrop-blur-xl">
          <div className="border-b border-cyan-200/15 bg-gradient-to-r from-slate-900/90 via-slate-950 to-slate-900/90 px-6 py-4 md:px-8">
            <h3 className="flex items-center gap-2.5 text-xl font-bold tracking-[-0.02em] text-slate-100 md:text-2xl">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg border border-cyan-300/30 bg-cyan-500/15 text-cyan-300">
        ...
        {latestProjects.length ? (
          <section className="mt-14">
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-cyan-400">Latest Projects</p>
