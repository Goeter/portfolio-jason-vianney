    ...
    <header className="sticky top-0 z-50 border-b border-zinc-800 bg-black shadow-[0_12px_45px_rgba(0,0,0,0.35)] backdrop-blur-xl">
      <div className="relative mx-auto flex h-[68px] w-full max-w-7xl items-center px-4 sm:px-8 lg:px-12">
        <Link href={backHref} className="relative z-10 shrink-0">
          <span className="group inline-flex items-center rounded-full border border-white/10 bg-zinc-950 px-4 py-2.5 text-sm font-semibold text-zinc-100 shadow-sm backdrop-blur-md transition-all duration-300 hover:-translate-x-1 hover:border-white hover:bg-white hover:text-black">
