...
type TypingElement = HTMLElement & {
  _typingTimer?: ReturnType<typeof setInterval>
}
...
export default function SplashLoader({
  ...
  const typeWriter = (
    ...
    const target = el as TypingElement
  ...
  const activateAtom = (index: number) => {
    atomRefs.current[index]?.classList.add(
      "active"
    )
  }
            ...
            runHyperspace(() => {
              ...
              setTimeout(() => {
                ...
                typeWriter(
                  ...
                  60,
                  () => {
                    expertRef.current?.classList.add(
                      "show"
                    )
